(function(){
    ...
    var headerimagefracheight = (realheaderimage.clientHeight/15).toString() + "px";
...
// 
    ...
    if ($window.scrollTop() < (realheaderimage.clientHeight-realheader.clientHeight)-realheaderimage.clientHeight/12){
        realheader.style.setProperty("box-shadow", "0 " + headerimagefracheight + " " + headerimagefracheight + " #aa0000ff");
    } else {
